...
<main>
    ...
    <div class="search-container">
        <input type="text" placeholder="Search By Title" class="searchinput" id="searchinput">
        <button class="mysearchbtn" onclick="searchbtnClick()">Search</button>
    </div>
            ...
            expertlist.forEach((expert,index)=>{
                var profileCard = `
                        <div class="artist_Card">
                            ...
                            <div class="userinfo" id="Name"><button onclick='viewDetails(${expert.art_id})' >View Details</button></div>
                        </div>`;
